...
<html>
<head>
    <title>Member Registation - Quoc Thang</title>
    <meta charset="UTF-8">
                    ...
                    <form action="" method="post">
                        <td>
                            <table width="100%" border="0" cellpadding="3" cellspacing="1">
                                <tr>
                                    <td colspan="3"><strong>MEMBER REGISTATION</strong></td>
                                </tr>
                                <tr>
                                ...
                                <tr>
                                    ...
                                    <td>&nbsp;</td>
                                    <td>
                                        <input type="submit" name="submit" value="Đăng ký" class="instabutton"/>
                                    </td>
                                </tr>
                            </table>
                        </td>
